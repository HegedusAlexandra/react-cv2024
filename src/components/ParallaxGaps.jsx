...
import Parallax from "parallax-js"; // Import the library

export default function ParallaxGaps() {
  ...
  return (
    <div className="container">
      <div className="layers bg-blue-950" ref={sceneRef} id="scene">
        <svg
          className="layer layer-1"
          data-depth="0.1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="-260.5 -143 1920 1080"
        >
          <path
            fill="#054B8C"
