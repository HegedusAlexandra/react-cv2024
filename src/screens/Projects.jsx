...
export default function Projects() {
  return (
    <div className="flex flex-col w-[100%] gap-[10px] md:px-[30%] px-[4%] py-[4%] md:py-[4%] md:bg-transparent bg-stone-200">
      <a href="https://hegedusalexandra.github.io/PCL/PCL.html" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh]">
      ...
      <a href="https://www.golfracks.club/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh]">
      ...
      <a href="https://hegedusalexandra.github.io/weather_forecast/frontend/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh]">
      ...
      <a href="https://leohunts.com/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh]">
      ...
      <a href="https://hegedusalexandra.github.io/bankist/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh]">
      ...
      <a href="https://hegedusalexandra.github.io/OMASKLEIDERSCHRANK/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh]">
      ...
      <a href="https://hegedusalexandra.github.io/small_projects/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh]">
