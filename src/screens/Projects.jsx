...
export default function Projects() {
  return (
    <div className="flex flex-col w-[100%] gap-[10px] md:px-[30%] px-[4%] py-[4%] md:py-[4%] bg-stone-200">
      <a href="https://hegedusalexandra.github.io/PCL/PCL.html" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh] shadow-[3px_5px_16px_5px_rgba(0,0,0,0.6)] ">
      ...
      <a href="https://www.golfracks.club/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh] shadow-[3px_5px_16px_5px_rgba(0,0,0,0.6)]">
      ...
      <a href="https://hegedusalexandra.github.io/weather_forecast/frontend/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh] shadow-[3px_5px_16px_5px_rgba(0,0,0,0.6)]">
      ...
      <a href="https://leohunts.com/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh] shadow-[3px_5px_16px_5px_rgba(0,0,0,0.6)]">
      ...
      <a href="https://hegedusalexandra.github.io/bankist/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh] shadow-[3px_5px_16px_5px_rgba(0,0,0,0.6)]">
      ...
      <a href="https://hegedusalexandra.github.io/OMASKLEIDERSCHRANK/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh] shadow-[3px_5px_16px_5px_rgba(0,0,0,0.6)]">
      <div className="w-[100%] h-[30vh] bg-OKS bg-top bg-cover rounded-2xl "></div>
        <div className="w-[100%]  pt-1 text-stone-100 font-opensans">
          <h2 className="font-opensans uppercase font-bold text-[4vh]">
            OMA's KLEIDERSCHRANK
          </h2>
          <p>I have made a website with react for a secon-hand clothshop, but since it closed,even though here is the website</p>
        </div>
      </a>   
      <a href="https://hegedusalexandra.github.io/small_projects/" className="flex-1 bg-stone-700 p-2 rounded-2xl mb-[4vh] shadow-[3px_5px_16px_5px_rgba(0,0,0,0.6)]">
