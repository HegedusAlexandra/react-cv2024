...
export default function Introduction() {
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-row justify-center w-[100%] md:bg-transparent bg-lemoncoconut bg-contain bg-no-repeat">
        <div className="flex flex-col items-end md:w-[50%] w-[90%] bg-[#ffffff14] backdrop-blur-sm md:bg-gradient-to-b from-[#f2be0300] to-[30%] to-[#FEE946]">
          <div className="md:absolute static md:w-[20vw] md:py-[10vh] py-[2vh] pr-[2vw] font-roboto text-[2vh]">
              ...
              { window.innerWidth < 780 && <p>Folyamatosan törekszem arra, hogy naprakész maradjak a legújabb
          ...
          {window.innerWidth > 780 && <img className="md:w-[100%] h-[100vh] md:h-auto object-cover" src={lemon} alt="lemon" />}
        </div>
        {window.innerWidth > 780 && <div className="flex flex-col items-start w-[50%] bg-transparent md:bg-[#CFC7B9]">
           <img className="md:w-[100%] h-[100vh] md:h-auto object-cover object-left" src={arrow} alt="arrow" />
          <div className="md:absolute static w-[40%] font-roboto py-[8vh] pl-[1vw] text-[2vh]">
            <p>
