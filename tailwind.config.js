...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        bgMove: "bgMove 120s ease-in-out infinite"
      },
      backgroundImage: {
        ...
        concrete: "url('./assets/pictures/concrete.jpg')",
        concrete2: "url('./assets/pictures/concrete2.jpg')",
        concrete2vertical: "url('./assets/pictures/concrete2vertical.jpg')",
